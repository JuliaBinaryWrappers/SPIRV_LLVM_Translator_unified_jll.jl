# `SPIRV_LLVM_Translator_unified_jll.jl` (v0.2.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/292bdd5510e024ee88c7347c99b571fc2e40c587/S/SPIRV_LLVM_Translator_unified/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/maleadt/SPIRV-LLVM-Translator.git (revision: `a16f3db323862cc49d31135697309a3188a024a8`)
